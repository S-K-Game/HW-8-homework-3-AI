...
public class PatrollerMinDist : MonoBehaviour
{
    ...
    private void SelectNewTarget()
    {
        ...
        {
            float distanceToPlayer = Vector3.Distance(player.transform.position, t.transform.position);
            if (distanceToPlayer < minDist)
            {
                minDist = distanceToPlayer;
                currentTarget = t;
                Debug.Log("New distance: " + minDist);
            }
        }
